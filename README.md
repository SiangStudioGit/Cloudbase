...
# Installation
Copying ```bash[Cloudbase.lua](https://github.com/SiangStudioGit/Cloudbase/blob/main/Cloudbase.lua)``` to ```ServerStorage```. Make sure it's a ModuleScript named ```Cloudbase```.
# Usage
